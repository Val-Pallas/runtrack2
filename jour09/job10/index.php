...
try {
    ...
    // SQL query to select all information from salles, sorted by capacite in ascending order
...
croissante. Affichez le résultat de cette requête dans un tableau HTML. La première
